...
function bench_install(string $storage, int $n, string $day): array {
    ...
    foreach (['viewer.php', 'submissions.php', 'bbf_auth.php', 'bbf_functions.php', 'bbf_storage.php', 'bbf_delivery.php', 'bbf_outbox.php', 'bbf_uploads.php', 'bbf_diagnostics.php', 'bbf_read.php', 'bbf_export.php', 'bbf_review.php', 'bbf_versions.php'] as $file) {
