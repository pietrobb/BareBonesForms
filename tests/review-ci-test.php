...
try {
    ...
    $required = [
        ...
        'System fields' => [__DIR__ . '/review-system-fields-test.php', [PHP_BINARY, __DIR__ . '/review-system-fields-test.php']],
        ...
        'Renderer and submission analytics' => [__DIR__ . '/review-analytics.test.js', ['node', '--test', __DIR__ . '/review-analytics.test.js']],
        'Visit context' => [__DIR__ . '/review-visit-context-test.js', ['node', __DIR__ . '/review-visit-context-test.js']],
